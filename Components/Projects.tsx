...
const Projects=()=>{
    return(
        <div className="pt-[4rem] md:pt-[8rem] pb-[5rem] bg-[#02050a]" >
            ...
            <div className="w-[80%] pt-[2rem] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[2rem] ">
                <div >
                    <div className="transform cursor-pointer hover:translate-y-6 transition-all duration-200 relative w-[100%] h-[200px] md:h-[300px]">
                        <a href="https://github.com/macsolo1332/coursecraft.git"> <Image  src="/images/p8.jpeg" alt="portfolio" layout="fill" className="object-contain"/></a>
            ...
            <div className="text-slate-50 justify-center md:mx-[39%] sm:mx-[20%] content-center"> 
            <ContactDock/>
            </div>
        </div>
    )
