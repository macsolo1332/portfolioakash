...
const ShinyButton = ({ text = "shiny-button" }) => {
  return (
    ...
    >
      <span
        className="relative block h-full w-full text-sm uppercase tracking-wide text-[rgba(253,253,253,0.65)] dark:font-light dark:text-[rgba(242,116,116,0.9)]"
        style={{
          maskImage:
      ...
      <span
        style={{
          mask: "linear-gradient(rgb(5,5,5), rgb(0,0,0)) content-box,linear-gradient(rgb(0,0,0), rgb(0,0,0))",
